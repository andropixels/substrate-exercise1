...
use frame_support::{
  dispatch::{Currency,Get,ReservableCurrency},
  ensure,
  traits::{Currency,Get,ReservableCurrency},
  PalletId,BoundedVec,
};
use primitive::Balance;
use sp_runtime::{
...
pub trait Config: frame_system::Config{
    ...
    type Event: From<Event<Self>> + InType<<Self as frame_system::Config>::Event>;
  ...
  pub fn total_supply(id:T::FungibleTokenId)->Result<Balance,DispatchError>{
    ...
    fn increase_balance(
       ...
       amount:Balance,
        ...
        Balance::<T>::try_mutate(id,to,|balance| -> DispatchResult{
    ...
    pub fn maybe_check_permission(id:T::FungibleTokenId,who:&T::AccountId) -> DispatchResult{
        let token =Token::<T>::get(id).ok_or(Error::<T>::InvalidId)?;
